...
+ (id)aquaSelectedGradient
  ...
  CTGradientElement color1;
  color1.red   = (CGFloat)0.58;
  color1.green = (CGFloat)0.86;
  color1.blue  = (CGFloat)0.98;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red   = (CGFloat)0.42;
  color2.green = (CGFloat)0.68;
  color2.blue  = (CGFloat)0.90;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)11.5/23;
  
  CTGradientElement color3;
  color3.red   = (CGFloat)0.64;
  color3.green = (CGFloat)0.80;
  color3.blue  = (CGFloat)0.94;
  color3.alpha = (CGFloat)1.00;
  color3.position = (CGFloat)11.5/23;
  
  CTGradientElement color4;
  color4.red   = (CGFloat)0.56;
  color4.green = (CGFloat)0.70;
  color4.blue  = (CGFloat)0.90;
  color4.alpha = (CGFloat)1.00;
  color4.position = (CGFloat)1;
...
+ (id)aquaNormalGradient
  ...
  CTGradientElement color1;
  color1.red = color1.green = color1.blue  = (CGFloat)0.95;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red = color2.green = color2.blue  = (CGFloat)0.83;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)11.5/23;
  
  CTGradientElement color3;
  color3.red = color3.green = color3.blue  = (CGFloat)0.95;
  color3.alpha = (CGFloat)1.00;
  color3.position = (CGFloat)11.5/23;
  
  CTGradientElement color4;
  color4.red = color4.green = color4.blue  = (CGFloat)0.92;
  color4.alpha = (CGFloat)1.00;
  color4.position = (CGFloat)1;
...
+ (id)aquaPressedGradient
  ...
  CTGradientElement color1;
  color1.red = color1.green = color1.blue  = (CGFloat)0.80;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red = color2.green = color2.blue  = (CGFloat)0.64;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)11.5/23;
  
  CTGradientElement color3;
  color3.red = color3.green = color3.blue  = (CGFloat)0.80;
  color3.alpha = (CGFloat)1.00;
  color3.position = (CGFloat)11.5/23;
  
  CTGradientElement color4;
  color4.red = color4.green = color4.blue  = (CGFloat)0.77;
  color4.alpha = (CGFloat)1.00;
  color4.position = (CGFloat)1;
...
+ (id)unifiedSelectedGradient
  ...
  CTGradientElement color1;
  color1.red = color1.green = color1.blue  = (CGFloat)0.85;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red = color2.green = color2.blue  = (CGFloat)0.95;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)1;
...
+ (id)unifiedNormalGradient
  ...
  CTGradientElement color1;
  color1.red = color1.green = color1.blue  = (CGFloat)0.75;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red = color2.green = color2.blue  = (CGFloat)0.90;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)1;
...
+ (id)unifiedPressedGradient
  ...
  CTGradientElement color1;
  color1.red = color1.green = color1.blue  = (CGFloat)0.60;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red = color2.green = color2.blue  = (CGFloat)0.75;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)1;
...
+ (id)unifiedDarkGradient
  ...
  CTGradientElement color1;
  color1.red = color1.green = color1.blue  = (CGFloat)0.68;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
...
+ (id)sourceListSelectedGradient
  ...
  CTGradientElement color1;
  color1.red   = (CGFloat)0.06;
  color1.green = (CGFloat)0.37;
  color1.blue  = (CGFloat)0.85;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red   = (CGFloat)0.30;
  color2.green = (CGFloat)0.60;
  color2.blue  = (CGFloat)0.92;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)1;
...
+ (id)sourceListUnselectedGradient
  ...
  CTGradientElement color1;
  color1.red   = (CGFloat)0.43;
  color1.green = (CGFloat)0.43;
  color1.blue  = (CGFloat)0.43;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0;
  
  CTGradientElement color2;
  color2.red   = (CGFloat)0.60;
  color2.green = (CGFloat)0.60;
  color2.blue  = (CGFloat)0.60;
  color2.alpha = (CGFloat)1.00;
  color2.position = (CGFloat)1;
...
+ (id)rainbowGradient
  ...
  CTGradientElement color1;
  color1.red   = (CGFloat)1.00;
  color1.green = (CGFloat)0.00;
  color1.blue  = (CGFloat)0.00;
  color1.alpha = (CGFloat)1.00;
  color1.position = (CGFloat)0.0;
  
  CTGradientElement color2;
  color2.red   = (CGFloat)0.54;
  color2.green = (CGFloat)0.00;
  color2.blue  = (CGFloat)1.00;
  color2.alpha = (CGFloat)1.00;
...
+ (id)hydrogenSpectrumGradient
  ...
  colorBands[0].position = (CGFloat).145;
  colorBands[0].width = (CGFloat).01;
  
  colorBands[1].hue = (CGFloat)200;
  colorBands[1].position = (CGFloat).71;
  colorBands[1].width = (CGFloat).008;
  
  colorBands[2].hue = (CGFloat)253;
  colorBands[2].position = (CGFloat).885;
  colorBands[2].width = (CGFloat).005;
  
  colorBands[3].hue = (CGFloat)275;
  colorBands[3].position = (CGFloat).965;
  colorBands[3].width = (CGFloat).003;
...
- (CTGradient *)removeColorStopAtPosition:(CGFloat)position
  ...
  if(isnan(removedElement.position))
	[NSException raise:NSRangeException format:@"-[%@ removeColorStopAtPosition:]: no such colorStop at position (%lf)", [self class], (double)position];
  
  return [newGradient autorelease];
  }

- (CTGradient *)removeColorStopAtIndex:(NSUInteger)index1
  {
  CTGradient *newGradient = [self copy];
  CTGradientElement removedElement = [newGradient removeElementAtIndex:index1];
  
  if(isnan(removedElement.position))
	[NSException raise:NSRangeException format:@"-[%@ removeColorStopAtIndex:]: index (%ld) beyond bounds", [self class], (long)index1];
...
- (NSColor *)colorStopAtIndex:(NSUInteger)index1
  {
  CTGradientElement *element = [self elementAtIndex:index1];
...
- (void)fillRect:(NSRect)rect angle:(CGFloat)angle
  ...
  if((NSInteger)angle == 0)		//screw the calculations - we know the answer
  	...
  	if(CGFloatAbs(CGFloatTan(rangle))<=1)	//for range [-45,45], [135,225]
		...
		sina = CGFloatSin(rangle);
		cosa = CGFloatCos(rangle);
		tana = CGFloatTan(rangle);
...
- (void)fillBezierPath:(NSBezierPath *)path angle:(CGFloat)angle
  ...
  [currentContext saveGraphicsState];
	id	transform = [[NSClassFromString( @"NSAffineTransform" ) alloc] init];
...
- (CTGradientElement)removeElementAtIndex:(NSUInteger)index1
  ...
  removedElement.red   = (CGFloat)0.0;
  removedElement.green = (CGFloat)0.0;
  removedElement.blue  = (CGFloat)0.0;
  removedElement.alpha = (CGFloat)0.0;
  removedElement.position = (CGFloat)NAN;
...
- (CTGradientElement)removeElementAtPosition:(CGFloat)position
  ...
  if(elementList != nil)
	...
	if(CGFloatAbs(elementList->position - position) < SM2D_EPSILON)
		{
		CTGradientElement *tmpNext = elementList;
		elementList = elementList->nextElement;
		...
		while(curElement->nextElement != nil)
			...
			if(CGFloatAbs(curElement->nextElement->position - position) < SM2D_EPSILON)
				{
				CTGradientElement *tmpNext = curElement->nextElement;
...
void transformRGB_HSV(CGFloat *components) //H,S,B -> R,G,B
	...
	if(CGFloatAbs(MAX - MIN) < SM2D_EPSILON)
		H = NAN;
	else if(CGFloatAbs(MAX - R) < SM2D_EPSILON)
		if(G >= B)
			H = 60*(G-B)/(MAX-MIN)+0;
		else
			H = 60*(G-B)/(MAX-MIN)+360;
	else if(CGFloatAbs(MAX - G) < SM2D_EPSILON)
		H = 60*(B-R)/(MAX-MIN)+120;
	else if(CGFloatAbs(MAX - B) < SM2D_EPSILON)
		H = 60*(R-G)/(MAX-MIN)+240;
	
	//S = MAX == 0 ? 0 : 1 - MIN/MAX;
	S = CGFloatAbs(MAX) < SM2D_EPSILON ? 0 : 1 - MIN/MAX;
	V = MAX;
...
void transformHSV_RGB(CGFloat *components) //H,S,B -> R,G,B
	{
	CGFloat R, G, B;
	CGFloat H = CGFloatMod(components[0],(CGFloat)359),	//map to [0,360]
		  S = components[1],
		  V = components[2];
	
	//(NSInteger)   Hi = (NSInteger)floorf(H/60.) % 6;	// (NSInteger) - causes warning
	NSInteger	  Hi = CGFloatFloor(H/(CGFloat)60.); // DFH
	Hi %= 6; // DFH

	CGFloat f  = H/(CGFloat)60-Hi,
		  p  = V*((CGFloat)1-S),
		  q  = V*((CGFloat)1-f*S),
		  t  = V*((CGFloat)1-((CGFloat)1-f)*S);
